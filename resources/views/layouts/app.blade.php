            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if(Auth::guard('admin')->user())
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/admin2/logout') }}"><i class="fa fa-btn fa-sign-out"></i>Logout</a></li>
                            </ul>
                        </li>
                    ...
                    @else
                        ...
                        <li><a href="{{ url('/admin2/login') }}">Login Admin</a></li>
                        <li><a href="{{ url('/register') }}">Register User</a></li>
                        <li><a href="{{ url('/admin2/register') }}">Register Admin</a></li>
                    @endif
                </ul>
            </div>
        </div>
